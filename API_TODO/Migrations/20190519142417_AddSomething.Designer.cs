...
namespace API_TODO.Migrations
{
    ...
    [Migration("20190519142417_AddSomething")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_TODO.Models.Authority", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("API_TODO.Models.Faculty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("API_TODO.Models.Users", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("API_TODO.Models.Users", b =>
                {
                    b.HasOne("API_TODO.Models.Authority", "Authorities")
                        .WithMany()
